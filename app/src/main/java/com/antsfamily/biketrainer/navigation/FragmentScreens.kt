...
class FragmentScreens {
    ...
    class ProgramScreen(private val isTime2work: Boolean, private val profile: String) :
        SupportAppScreen() {
    ...
    class ScanScreen(private val profileName: String, private val program: Program) :
        SupportAppScreen() {
    ...
    class WorkScreen(
        private val devices: ArrayList<MultiDeviceSearch.MultiDeviceSearchResult>,
        private val program: String,
        private val profileName: String
    ) : SupportAppScreen() {
        override fun getFragment(): Fragment =
            WorkoutFragment.newInstance(devices, program, profileName)
