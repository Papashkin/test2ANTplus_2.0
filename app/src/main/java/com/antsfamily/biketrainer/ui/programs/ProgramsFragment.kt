...
import com.antsfamily.biketrainer.presentation.programs.ProgramsView
...
class ProgramsFragment : BaseFragment(R.layout.fragment_programs),
    ...
    companion object {
        ...
        fun newInstance(isTime2work: Boolean, profile: String): ProgramsFragment = ProgramsFragment()
            .apply {
